    ...
    fn get_modified_setup(
        ...
        let final_setup = value_retrievers(self.dirs_wrapper.as_ref())
            ...
            .filter_map(|retriever| {
                ...
                let value = match combined_setup.get(retriever.value_name()) {
                ...
                if !retriever.include_when_blank() && [Blank, Required].contains(&value.1.status) {
                    None
                } else {
                    Some(value)
                }
...
trait ValueRetriever {
    ...
    fn include_when_blank(&self) -> bool {
        true
    }
}
...
struct ReceiptSettlementContract {}
impl ValueRetriever for ReceiptSettlementContract {
    fn value_name(&self) -> &'static str {
...
fn value_retrievers(dirs_wrapper: &dyn DirsWrapper) -> Vec<Box<dyn ValueRetriever>> {
    vec![
        ...
        Box::new(ReceiptSettlementContract {}),
        Box::new(Chain {}),
...
mod tests {
    ...
    fn get_modified_setup_database_populated_only_requireds_set() {
        ...
        let expected_result = vec![
            ...
            (
                "neighbors",
                "masq://base-mainnet:QUJDRDU2Nzg5MDEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@1.2.3.4:1234,masq://base-mainnet:RUZHSDU2Nzg5MDEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@5.6.7.8:5678",
                Configured,
            ),
    ...
    fn get_modified_setup_database_nonexistent_everything_preexistent() {
        ...
        let existing_setup = setup_cluster_from(vec![
            ...
            ("neighbors", "masq://base-sepolia:MTIzNDU2Nzg5MTEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@1.2.3.4:1234,masq://base-sepolia:Si06R3ulkOjJOLw1r2R9GOsY87yuinHU_IHK2FJyGnk@5.6.7.8:5678", Set),
    ...
    fn get_modified_setup_database_nonexistent_everything_set() {
        ...
        let incoming_setup = vec![
            ...
            ("neighbors", "masq://base-sepolia:MTIzNDU2Nzg5MTEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@1.2.3.4:1234,masq://base-sepolia:Si06R3ulkOjJOLw1r2R9GOsY87yuinHU_IHK2FJyGnk@5.6.7.8:5678"),
            ("new-public-key", "on"),
    ...
    fn get_modified_setup_database_nonexistent_nothing_set_everything_in_environment() {
        ...
        vec![
            ...
            ("MASQ_NEIGHBORS", "masq://base-sepolia:MTIzNDU2Nzg5MTEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@1.2.3.4:1234,masq://base-sepolia:Si06R3ulkOjJOLw1r2R9GOsY87yuinHU_IHK2FJyGnk@5.6.7.8:5678"),
        ...
        let expected_result = vec![
            ...
            ("neighbors", "masq://base-sepolia:MTIzNDU2Nzg5MTEyMzQ1Njc4OTIxMjM0NTY3ODkzMTI@1.2.3.4:1234,masq://base-sepolia:Si06R3ulkOjJOLw1r2R9GOsY87yuinHU_IHK2FJyGnk@5.6.7.8:5678", Configured),
    ...
    #[test]
    fn receipt_settlement_contract_retriever_accepts_a_valid_setup_value() {
        let _guard = EnvironmentGuard::new();
        let setup = setup_cluster_from(vec![(
            "receipt-settlement-contract",
        ...
        let command_line = SetupReporterReal::make_command_line(&setup);
        let multi_config = SetupReporterReal::make_multi_config(
        ...
        .unwrap();
        let subject = ReceiptSettlementContract {};

        assert_eq!(
            subject.set_value(&multi_config),
            Some("0x7777777777777777777777777777777777777777".to_string())
        );
        assert!(!subject.include_when_blank());
    }
    ...
    fn dumb_requirements() {
        ...
        assert_eq!(ReceiptSettlementContract {}.is_required(&params), false);
    ...
    fn value_retrievers_know_their_names() {
        ...
        assert_eq!(
            ReceiptSettlementContract {}.value_name(),
            "receipt-settlement-contract"
        );
