        ...
        .map(|account| UiReceivableAccount {
            ...
            balance_gwei: {
                ...
                if gwei != 0 {
                    ...
                    panic!(
                        "Broken code: ReceivableAccount with balance \
                 between {} and 0 gwei passed through db query constraints; balance: {}",
