...
use crate::sub_lib::blockchain_bridge::{
    ProviderSettlementReconciliationRequest, ProviderSettlementReconciliationResult,
};
...
use crate::sub_lib::proxy_client::{
    ClientResponsePayload_0v1, InboundServerData, MeteredClientResponsePayload_0v1,
};
...
use crate::sub_lib::proxy_server::{RecordExitRequestForReceipt, RetryReceiptAcknowledgements};
...
recorder_message_handler_t_m_p!(ExpiredCoresPackage<MeteredClientResponsePayload_0v1>);
recorder_message_handler_t_m_p!(ExpiredCoresPackage<DnsResolveFailure_0v1>);
recorder_message_handler_t_m_p!(ExpiredCoresPackage<ServiceReceiptOfferPayload_0v1>);
...
recorder_message_handler_t_m_p!(ProviderSettlementReconciliationRequest);
recorder_message_handler_t_m_p!(ProviderSettlementReconciliationResult);
...
recorder_message_handler_t_m_p!(ReportRoutingServicesConsumedMessage);
...
pub fn make_accountant_subs_from_recorder(addr: &Addr<Recorder>) -> AccountantSubs {
    AccountantSubs {
        ...
        report_routing_services_consumed: recipient!(addr, ReportRoutingServicesConsumedMessage),
...
pub fn make_blockchain_bridge_subs_from_recorder(addr: &Addr<Recorder>) -> BlockchainBridgeSubs {
    BlockchainBridgeSubs {
        ...
        provider_settlement_reconciliation: recipient!(
            addr,
            ProviderSettlementReconciliationRequest
        ),
    }
}
