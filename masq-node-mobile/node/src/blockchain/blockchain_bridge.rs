...
use crate::sub_lib::blockchain_bridge::{
    BlockchainBridgeSubs, OutboundPaymentsInstructions, ProviderSettlementReconciliationRequest,
...
pub struct BlockchainBridge {
    ...
    provider_settlement_reconciliation_result_sub_opt:
        Option<Recipient<ProviderSettlementReconciliationResult>>,
}
...
impl Handler<BindMessage> for BlockchainBridge {
    ...
    fn handle(&mut self, msg: BindMessage, _ctx: &mut Self::Context) -> Self::Result {
        ...
        self.provider_settlement_reconciliation_result_sub_opt = Some(
            msg.peer_actors
                .hopper
                .provider_settlement_reconciliation_result,
        );
...
impl Handler<ProviderSettlementReconciliationRequest> for BlockchainBridge {
    type Result = ();

    fn handle(
        &mut self,
        msg: ProviderSettlementReconciliationRequest,
        _ctx: &mut Self::Context,
    ) -> Self::Result {
        let result_recipient = self
            .provider_settlement_reconciliation_result_sub_opt
            .clone()
        ...
        let future = self
            ...
            .settlement_claims_at_confirmation_depth(
                msg.settlement_contract,
                msg.claim_ids,
                msg.confirmation_depth,
            )
            .then(move |result| {
                result_recipient
                    .try_send(ProviderSettlementReconciliationResult {
                        response_context,
...
impl BlockchainBridge {
    pub fn new(
        ...
        BlockchainBridge {
            ...
            provider_settlement_reconciliation_result_sub_opt: None,
        }
    }
...
mod tests {
    ...
    fn handle_retrieve_transactions_receives_invalid_topics() {
        ...
        TestLogHandler::new().exists_log_containing(&format!(
            "WARN: {test_name}: Invalid response from blockchain server (1 log entries)"
        ));
    }
