...
pub fn sign_and_append_payment(
    ...
    debug!(
        logger,
        "Appending outbound transaction; amount: {} wei, nonce: {}, gas price: {} wei",
...
pub fn send_payables_within_batch(
    ...
    debug!(
        logger,
        "Common attributes of payables to be transacted: contract: {:?}, chain_id: {}",
        chain.rec().contract,
...
mod tests {
    ...
    fn sign_and_append_payment_works() {
        ...
        TestLogHandler::new().exists_log_containing(&format!(
            "DEBUG: {test_name}: Appending outbound transaction; amount: 1,000,000,000 wei, \
            nonce: 1, \
    ...
    fn transmission_log_is_well_formatted() {
        ...
        [REDACTED]                                   900,000,000,000,000,000   246,913,578\n\
        [REDACTED]                                   123,456,789               493,827,156\n\
        [REDACTED]                                   33,355,666,000,000,000    740,740,734\n";
        ...
        \n\
        [wallet address]                             [payment wei]        [gas price wei]\n\
        [REDACTED]                                   5,400,000,000,000    246,913,578\n\
        [REDACTED]                                   10,000,000,000,000   493,827,156\n\
        [REDACTED]                                   44,444,555           740,740,734\n";
        ...
        \n\
        [wallet address]                             [payment wei]   [gas price wei]\n\
        [REDACTED]                                   45,000,888      246,913,578\n\
        [REDACTED]                                   1,999,999       493,827,156\n\
        [REDACTED]                                   444,444,555     740,740,734\n";
    ...
    fn test_send_payables_within_batch(
        ...
        tlh.exists_log_containing(&format!(
            "DEBUG: {test_name}: Common attributes of payables to be transacted: contract: {:?}, chain_id: {}",
            chain.rec().contract,
            chain.rec().num_chain_id,
        ));
    ...
    #[test]
    #[should_panic(
        expected = "Consuming wallet doesn't contain a secret key: Signature(\"Cannot sign with non-keypair wallet: Address([REDACTED]).\")"
    )]
