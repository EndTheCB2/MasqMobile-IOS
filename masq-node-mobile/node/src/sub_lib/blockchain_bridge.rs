...
use crate::accountant::db_access_objects::receipt_checkpoint_dao::SettlementChainObservation;
...
pub struct BlockchainBridgeConfig {
    ...
    pub chain: Chain,
    /// Explicit EIP-712 verifier/escrow. This must never default to the MASQ ERC-20 address.
...
pub struct BlockchainBridgeSubs {
    ...
    pub provider_settlement_reconciliation: Recipient<ProviderSettlementReconciliationRequest>,
}
...
pub struct ProviderSettlementReconciliationContext {
    pub client_id: u64,
    pub context_id: u64,
    pub start_after_claim_id_opt: Option<[u8; 32]>,
    pub next_cursor_opt: Option<[u8; 32]>,
    pub candidate_count: usize,
}

#[derive(Clone, Debug, Message, PartialEq, Eq)]
pub struct ProviderSettlementReconciliationRequest {
    pub settlement_contract: Address,
    pub claim_ids: Vec<[u8; 32]>,
    pub confirmation_depth: u64,
    pub response_context: ProviderSettlementReconciliationContext,
}

#[derive(Clone, Debug, Message, PartialEq, Eq)]
pub struct ProviderSettlementReconciliationResult {
    pub response_context: ProviderSettlementReconciliationContext,
    pub result: Result<SettlementChainObservation, String>,
}
