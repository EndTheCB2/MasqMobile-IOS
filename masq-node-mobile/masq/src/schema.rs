...
use crate::commands::provider_settlement_command::provider_settlement_subcommand;
use crate::commands::receipt_session_command::receipt_session_subcommand;
...
pub fn app() -> App<'static, 'static> {
    app_head()
        ...
        .subcommand(provider_settlement_subcommand())
        .subcommand(recover_wallets_subcommand())
        .subcommand(receipt_session_subcommand())
