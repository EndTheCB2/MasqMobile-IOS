...
impl Debug for ConfigurationCommand {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ConfigurationCommand")
            .field(
                "db_password",
...
mod tests {
    ...
    fn debug_redacts_database_password() {
        let subject = ConfigurationCommand {
            db_password: Some("SENSITIVE_DB_PASSWORD".to_string()),
        };
