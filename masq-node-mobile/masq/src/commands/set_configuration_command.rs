...
impl Debug for SetConfigurationCommand {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("SetConfigurationCommand")
...
mod tests {
    #[test]
    fn debug_redacts_configuration_value() {
        let subject = SetConfigurationCommand {
            name: "blockchain-service-url".to_string(),
            value: "SENSITIVE_CONFIG_VALUE".to_string(),
        };
