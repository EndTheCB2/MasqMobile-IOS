...
mod tests {
    ...
    fn two_way_transaction_handles_deserialization_error() {
        ...
        assert_eq!(
            ...
            "Node or Daemon is acting erratically: Unexpected two-way message from context 1234 with opcode 'booga'; payload contents redacted (11 bytes)\n".to_string()
        );
    }
    ...
    fn command_error_displays_properly() {
        ...
        assert_eq!(
            ...
            "Could not deserialize message from Daemon or Node: string; error payload code 1234; message contents redacted".to_string()
        );
        assert_eq!(
