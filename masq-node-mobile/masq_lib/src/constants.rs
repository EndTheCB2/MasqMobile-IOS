...
pub const RECEIPT_SESSION_RECOVERY_KEY: &str = "receipt_session_recovery_key";
...
pub const SERVICE_RECEIPT_PAYLOAD_CURRENT_VERSION: DataVersion = DataVersion { major: 0, minor: 1 };
pub const SERVICE_RECEIPT_OFFER_PAYLOAD_CURRENT_VERSION: DataVersion =
    DataVersion { major: 0, minor: 1 };
pub const METERED_CLIENT_RESPONSE_PAYLOAD_CURRENT_VERSION: DataVersion =
    DataVersion { major: 0, minor: 1 };
...
pub const RECEIPT_SESSION_ERROR: u64 = UI_NODE_COMMUNICATION_PREFIX | 9;
pub const PROVIDER_SETTLEMENT_ERROR: u64 = UI_NODE_COMMUNICATION_PREFIX | 10;
...
mod tests {
    ...
    fn constants_have_correct_values() {
        ...
        assert_eq!(
            SERVICE_RECEIPT_PAYLOAD_CURRENT_VERSION,
            DataVersion { major: 0, minor: 1 }
        );
        assert_eq!(
            SERVICE_RECEIPT_OFFER_PAYLOAD_CURRENT_VERSION,
            DataVersion { major: 0, minor: 1 }
        );
        assert_eq!(
            METERED_CLIENT_RESPONSE_PAYLOAD_CURRENT_VERSION,
            DataVersion { major: 0, minor: 1 }
        );
